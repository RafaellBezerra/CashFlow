...
public class ExpenseReportPdfUseCase : IExpenseReportPdfUseCase
{
    ...
    public ExpenseReportPdfUseCase(IExpenseReadOnlyRepository repository, ILoggedUser loggedUser)
    {
    ...
    public async Task<byte[]> Execute(DateOnly month)
    {
        ...
        foreach(var expense in expenses)
        {
            ...
            if (string.IsNullOrWhiteSpace(expense.Description) == false)
            {
                ...
                descriptionRow.Cells[0].Format.Font = new Font { Name = FontHelped.WORKSANS_REGULAR, Size = 10, Color = ColorsHelper.BLACK };
    ...
    private Document CreateDocument(string author, DateOnly month)
    {
        ...
        document.Info.Title = $"{ResourceReportGenerationMessage.EXPENSE_FOR} {month:Y}";
        document.Info.Author = author;

        var style = document.Styles["Normal"];
        style!.Font.Name = FontHelped.RALEWAY_REGULAR;
    ...
    private void CreateHeaderWithProfilePhotoAndName(string author, Section page)
    {
        ...
        var pathFile = Path.Combine(directoryName!, "Logo", "Rafael.jpg");

        row.Cells[0].AddImage(pathFile);
        row.Cells[1].AddParagraph($"Hey, {author}");
        row.Cells[1].Format.Font = new Font { Name = FontHelped.RALEWAY_BLACK, Size = 16 };
    ...
    private void CreateTotalSpentSection(Section page, DateOnly month, decimal totalExpenses)
    {
        ...
        paragraph.AddFormattedText(title, new Font { Name = FontHelped.RALEWAY_REGULAR, Size = 15 });

        paragraph.AddLineBreak();

        paragraph.AddFormattedText($"{totalExpenses:f2} {CURRENCY_SYMBOL}", new Font { Name = FontHelped.WORKSANS_BLACK, Size = 50 });
    }
    ...
    private void AddExpenseTitle(Cell cell, string expenseTitle)
    {
        ...
        cell.Format.Font = new Font { Name = FontHelped.RALEWAY_BLACK, Size = 14, Color = ColorsHelper.BLACK };
    ...
    private void AddHeaderForAmount(Cell cell)
    {
        ...
        cell.Format.Font = new Font { Name = FontHelped.RALEWAY_BLACK, Size = 14, Color = ColorsHelper.WHITE };
    ...
    {
        cell.Format.Font = new Font { Name = FontHelped.WORKSANS_REGULAR, Size = 12, Color = ColorsHelper.BLACK };
    ...
    private void AddAmountForExpense(Cell cell, decimal amount)
    {
        ...
        cell.Format.Font = new Font { Name = FontHelped.WORKSANS_REGULAR, Size = 14, Color = ColorsHelper.BLACK };
